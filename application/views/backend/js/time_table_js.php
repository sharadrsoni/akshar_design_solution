...
<script type="text/javascript" src="assets/plugins/fullcalendar/fullcalendar/fullcalendar.min.js"></script><!-- For Calendar -->

<!-- END PAGE LEVEL PLUGINS -->
<script src="<?php echo base_url() ."assets/pagescript/app.js"; ?>"></script>
<script src="<?php echo base_url() ."assets/pagescript/TimeTable.js"; ?>"></script>
<script>
