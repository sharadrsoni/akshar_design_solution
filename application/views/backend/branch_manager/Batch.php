...
<head>
    ...
    <?php include "Css.php" ?><!-- INCLUDE CORE CSS -->
	<link rel="stylesheet" type="text/css" href="assets/plugins/select2/select2_metro.css" />
	<link rel="stylesheet" type="text/css" href="assets/plugins/jquery-ui/jquery-ui-1.10.1.custom.min.css"/>
	<link rel="stylesheet" href="assets/plugins/data-tables/DT_bootstrap.css" /><!-- Css For Table -->
...
<body>
    <div id="wrapper" class="fixed-header fixed-sidebar">
        ...
        <div id="canvas">
			...
			<?php include "Header.php" ?><!-- INCLUDE CORE CSS -->
            <!--/ END Template Header -->

            <!-- START Template Sidebar -->
            <?php include "Slidermenu.php" ?><!-- INCLUDE CORE CSS -->
									...
									<div class="body-inner">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<span class="help-inline">To &nbsp;</span><input type="text" name="end_time" id="end_time" value="2:30 PM" data-format="hh:mm A" class="m-wrap small clockface_1" />
											</div>
										</div><!--/ Batch Time -->
										...
										<div class="control-group">
											...
											<div class="controls">
												<button type="button" class="btn green span4">Success</button>
												<div class="span8"></div>
											</div>
										</div>
						...
						<div class="row-fluid">
							...
							<div class="span12 widget lime">
								<header>
									...
									<!--/ END Label/Badge -->
									<ul class="nav nav-tabs nav-stacked pull-right">
										<li><a role="button" data-toggle="modal" href="#form_batch"><span class="icon icone-home"></span> Add Batch</a></li>
									 </ul>
									<!-- START Button Group -->
    ...
    <?Php include "Jscript.php" ?><!-- INCLUDE core JavaScript -->
