			...
			<div class="row-fluid">
				...
				<div class="tabbable" style="margin-bottom: 25px;">
					<ul class="nav nav-tabs">
						...
						<li class="">
							<a href="#tab2" data-toggle="tab"><span class="icon icone-pencil"></span> Submit Report</a>
						</li>
					</ul>
										...
										<tbody>
											...
											if(isset($target_report_list))
											{
												foreach($target_report_list as $key)
												{
													...
													<td ><span class=\"label label-success\"><a href=\"#tab2\" data-toggle=\"tab\" id=\"open_form\" target_report='{$key->targetId}'s><span class=icon icone-pencil></span> Submit Report</a></span> <span class=\"label label-success\"><a href='" . base_url() . "branch_manager/delete_taget/{$key->targetId}'>Edit</span></td>
													</tr>";
												}
											}
											?>
