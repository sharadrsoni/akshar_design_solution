...
class Login extends CI_Controller {
	...
	public function index() {
		...
		$getUserId = $this -> session -> userdata("roleId");
		if ($getUserId != null) {
			switch ($getUserId) {
				case 1 :
					redirect("admin");
