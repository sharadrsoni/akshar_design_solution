			...
			if (isset($_POST['submitStaff'])) {
				...
				if ($this -> form_validation -> run() == FALSE) {
					...
					if ($_POST['staffId'] == "") {
						...
						$text = 'Hi ' . $_POST['first_name'] . ' ' . $_POST['middle_name'] . ' ' . $_POST['last_name'] . ',' . "<br>" . 'This mail is from <b>Akshar Design Solution</b> to provide you confirmation that your registration has been done successfully.' . "<br><br>" . 'Your Login Credentials are:' . "<br>" . 'Username - ' . $staffData['userId'] . "<br>" . 'Password - ' . $staffData['userPassword'] . "<br><br><br>" . 'You are Required to login and change password <a href="localhost/akshar_design_solution/login/" target="_blank">Login Here</a>';
