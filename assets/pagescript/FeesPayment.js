var StudentFeesTable = function () {
    return {
        ...
        init: function () {
            ...
            jQuery('#tblfeespyament .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#tblfeespyament .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            //jQuery('#tblEvent .dataTables_length select').select2(); // initialize select2 dropdown
        }
    };
}();
var FeesPaymentValidation = function () {
...
var StudentRegistrationUIJQueryUI = function () {
