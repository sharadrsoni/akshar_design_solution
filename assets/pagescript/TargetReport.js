var TargetReportTable = function () {
    return {
        ...
        init: function () {
            ...
            jQuery('#tblTargetReport .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#tblTargetReport .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
            //jQuery('#tblEvent .dataTables_length select').select2(); // initialize select2 dropdown
        }
    };
}();

var TargetReportValidation = function () {
...
var TargetReportUIJQueryUI = function () {
