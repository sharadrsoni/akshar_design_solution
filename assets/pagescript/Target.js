...
var TargetTable = function () {
    return {
        ...
        init: function () {
            ...
            jQuery('#tblTarget .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#tblTarget .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
