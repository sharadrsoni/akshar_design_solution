var EventTable = function () {
    return {
        ...
        init: function () {
            ...
            jQuery('#tblEvent .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#tblEvent .dataTables_length select').addClass("m-wrap small"); // modify table per page dropdown
