...
jQuery.validator.addMethod("lettersonlywithoutspecial", function(b, a) {
	return this.optional(a) || /^[a-z]+$/i.test(b)
}, "Letters only please");
...
function getCurrentDate()
{
   ...
   var yyyy = tdate.getFullYear(); //yields year
	var currDate = yyyy + "/" +( MM+1) + "/" + dd;
	return currDate;
}
jQuery.validator.addMethod("greaterThan", function(value, element, params) {
	
	if (new Date(changedateformat(value)) > new Date(changedateformat($(params).val()))) {
		return true;
	}
	return false;
...
$.validator.addMethod("maxDate", function(value, element) {
     ...
     var inputDate = changedateformat(value);
...
$.validator.addMethod("minDate", function(value, element) {
	...
	if (new Date(changedateformat(value)) > new Date(getCurrentDate())) {
		return true;
	}
	return false;
